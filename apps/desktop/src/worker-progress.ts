...
export type WorkerStep = {step:{key:string;title:string;level:number;owned_paths?:string[];goal?:string;dependencies?:string[];acceptance?:string[]};status:string;target:{model:string;reasoning:string|null};child_id?:string|null;output?:string|null;error?:string|null;capsule?:string|null;usage?:Record<string,unknown>[];verification:{status?:string;command?:string;exit_code?:number|null;target_revision?:string;log_ref?:string;output?:string}[]};
