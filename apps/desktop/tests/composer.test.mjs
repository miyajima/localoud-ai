...
test('late AI completion cannot cross project or replace edited input',async()=>{
 ...
 assert.equal(input.value,'別の依頼');assert.match(document.querySelector('#composer-suffix').textContent,/Luna \/ low/);assert.match(document.querySelector('#composer-hint').textContent,/ローカル未接続/);
