...
- OrgBrain credentials use the platform keychain. The local ChatGPT bridge pairing token is generated per installation and stored in the local SQLite settings and Chrome extension storage; neither is included in this repository. Do not share these runtime files.
