...
(dest/'frozen-inputs.json').write_text(json.dumps({n:hashlib.sha256((root/n).read_bytes()).hexdigest() for n in ['contract.txt','acceptance.py','local/request.json','run_qwen35.py']},indent=2)+'\n')
